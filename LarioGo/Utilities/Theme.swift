...
enum Theme {
    ...
    static let azure = Color(red: 0x00 / 255.0, green: 0x4E / 255.0, blue: 0x64 / 255.0)
    /// Clear Water Teal — interactive accent (buttons, highlights, pins).
    static let teal = Color(red: 0x25 / 255.0, green: 0xA1 / 255.0, blue: 0x8E / 255.0)
    /// Sand White — light background.
    static let sand = Color(red: 0xF8 / 255.0, green: 0xF9 / 255.0, blue: 0xFA / 255.0)
    /// Warm accent used sparingly for tickets / calls to action.
    static let coral = Color(red: 0xFF / 255.0, green: 0x8C / 255.0, blue: 0x61 / 255.0)
    ...
    static let deepGradient = LinearGradient(
        colors: [
            Color(red: 0x00 / 255.0, green: 0x3B / 255.0, blue: 0x4D / 255.0),
            azure,
            teal,
        ],
...
extension Color {
    ...
    static let inkPrimary = Color(red: 0x10 / 255.0, green: 0x28 / 255.0, blue: 0x30 / 255.0)
    static let inkSecondary = Color(red: 0x4A / 255.0, green: 0x5A / 255.0, blue: 0x60 / 255.0)
}
